...
``` purescript
deleteCloudFrontOriginAccessIdentity :: forall eff. DeleteCloudFrontOriginAccessIdentityRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteDistribution :: forall eff. DeleteDistributionRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteStreamingDistribution :: forall eff. DeleteStreamingDistributionRequest -> Aff (exception :: EXCEPTION | eff) NoOutput
```

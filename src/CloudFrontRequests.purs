...
deleteCloudFrontOriginAccessIdentity :: forall eff. CloudFront.Service -> CloudFrontTypes.DeleteCloudFrontOriginAccessIdentityRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deleteDistribution :: forall eff. CloudFront.Service -> CloudFrontTypes.DeleteDistributionRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
deleteStreamingDistribution :: forall eff. CloudFront.Service -> CloudFrontTypes.DeleteStreamingDistributionRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
tagResource :: forall eff. CloudFront.Service -> CloudFrontTypes.TagResourceRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
...
untagResource :: forall eff. CloudFront.Service -> CloudFrontTypes.UntagResourceRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
